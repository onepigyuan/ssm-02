...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="../../jsp/student/complete_curriculum.jsp" style="background-color: #E6E6FA"><span class="icon-caret-right"></span>已修课程</a></li>
...
<ul class="bread">
  ...
  <li><a href="#" id="a_leader_txt">已修课程</a></li>
...
<script>
  ...
  layui.use('table', function(){
    ...
    table.render({
      ...
      ,page: true
      , limit:10
      ,url:'/ssm-02/completeCurriculumJson'
    ...
    $('#select_btn').click(function () {
      ...
      table.reload('test', {
        url: '/complete_curriculum_select_filter'
        , request: {
