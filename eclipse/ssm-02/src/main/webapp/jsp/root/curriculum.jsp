...
<div class="leftnav">
    ...
    <ul style="display:block">
        ...
        <li><a href="../../jsp/root/curriculum.jsp" style="background-color: #E6E6FA"><span class="icon-caret-right"></span>课程管理</a></li>
...
<ul class="bread">
    ...
    <li><a href="#" id="a_leader_txt">课程管理</a></li>
...
<div id="curriculum_update" style="display: none">
    ...
    <input style='margin-top:10px;' id='curriculum_name' type='text' class='layui-layer-input' placeholder='请输入课程名称'>
    <input style='margin-top:10px;' id='curriculum_teacher_id' type='text' class='layui-layer-input' placeholder='请输入授课老师编号'>
    <input style='margin-top:10px;' id='curriculum_date' type='date' class='layui-layer-input' placeholder='请输入上课时间'>
    <input style='margin-top:10px;' id='curriculum_place' type='text' class='layui-layer-input' placeholder='请输入上课地点'>
    <input style='margin-top:10px;' id='curriculum_week' type='text' class='layui-layer-input' placeholder='请输入周数'>
    <input style='margin-top:10px;' id='curriculum_type' type='text' class='layui-layer-input' placeholder='请输入课程类型'>
    <input style='margin-top:10px;' id='curriculum_credit' type='text' class='layui-layer-input' placeholder='请输入学分'>
</div>
...
<script>
    ...
    layui.use('table', function(){
        ...
        $('#select_btn').click(function () {
            ...
            table.reload('test', {
                url: '/ssm-02/curriculum_select_filter'
                , request: {
        ...
        document.getElementById('add').addEventListener('click',function (data) {
            layer.open({
                ...
                ,skin: 'layui-layer-prompt'
                ,content: "<div id='test'>" +
                    "<input style='margin-top:10px;' id='add_curriculum_name' type='text' class='layui-layer-input' placeholder='请输入课程名称'>" +
                    "<input style='margin-top:10px;' id='add_curriculum_teacher_id' type='text' class='layui-layer-input' placeholder='请输入授课老师编号'>" +
                    "<input style='margin-top:10px;' id='add_curriculum_date' type='date' class='layui-layer-input' placeholder='请输入上课时间'>" +
                    "<input style='margin-top:10px;' id='add_curriculum_place' type='text' class='layui-layer-input' placeholder='请输入上课地点'>" +
                    "<input style='margin-top:10px;' id='add_curriculum_week' type='text' class='layui-layer-input' placeholder='请输入周数'>" +
                    "<input style='margin-top:10px;' id='add_curriculum_type' type='text' class='layui-layer-input' placeholder='请输入课程类型'>" +
                    "<input style='margin-top:10px;' id='add_curriculum_credit' type='text' class='layui-layer-input' placeholder='请输入学分'>" +


                    "</div>"
                ,yes: function(index, layero){
                    if (
                        $("#add_curriculum_name").val()=='' ||
                        $("#add_curriculum_teacher_id").val()=='' ||
                        $("#add_curriculum_date").val()=='' ||
                        $("#add_curriculum_place").val()=='' ||
                        $("#add_curriculum_type").val()=='' ||
                        $("#add_curriculum_credit").val()=='' ||
                        $("#add_curriculum_week").val()==''

                    ){
                        layer.msg("请输入完整，不能为空！",{icon:5});
                    }else {
                        $.ajax({
                            url: "/ssm-02/curriculumInsert",
                            type: "POST",
                            data: {

                                "curriculum_name": $("#add_curriculum_name").val()
                                , "curriculum_teacher_id": $("#add_curriculum_teacher_id").val()
                                , "curriculum_date": $("#add_curriculum_date").val()
                                , "curriculum_place": $("#add_curriculum_place").val()
                                , "curriculum_week": $("#add_curriculum_week").val()
                                , "curriculum_type": $("#add_curriculum_type").val()
                                , "curriculum_credit": $("#add_curriculum_credit").val()
                            },
                            dataType: "json",
                            success: function (data) {
                                console.log(data)
                                if (data == 1) {
                                    ...
                                    $("#curriculum_name").val('')
                                    $("#curriculum_teacher_id").val('')
                                    $("#curriculum_date").val('')
                                    $("#curriculum_place").val('')
                                    $("#curriculum_week").val('')
                                    $("#curriculum_type").val('')
                                    $("#curriculum_credit").val('')
