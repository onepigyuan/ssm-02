        ...
        success: function (data) {
          ...
          if (data == 1) {
            layer.msg("登录成功",{icon:6,time:1500},function () {
              window.location.href = 'jsp/root/student.jsp';
            });
          } else if (data == 2) {
            layer.msg("登录成功",{icon:6,time:1500},function () {
              window.location.href = 'jsp/teacher/my_curriculum.jsp';
            });

          } else if (data == 3) {
            layer.msg("登录成功",{icon:6,time:1500},function () {
              window.location.href = 'jsp/student/all_curriculum.jsp';
            })
          } else if (data==404){
