...
window.onload = function() {	// 页面加载之后, 获取页面中的对象
	...
	usernameObj = document.getElementById("register_username");
	passwordObj = document.getElementById("register_password");
	confirmObj = document.getElementById("register_passwor2");
