...
<div class="leftnav">
    ...
    <ul style="display:block">
        <li><a href="../../jsp/student/all_curriculum.jsp" ><span class="icon-caret-right"></span>所有课程</a></li>
        ...
        <li><a href="../../jsp/student/password.jsp" style="background-color: #E6E6FA"><span class="icon-caret-right"></span>修改密码</a></li>
    ...
    <div class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input style="cursor:not-allowed" disabled="disabled" type="text" name="username" id="user_username" value="${sessionScope.student_username}" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button type="submit" class="layui-btn" lay-submit="" lay-filter="demo1" onclick="student_btn()">立即提交</button>
                <button type="reset" class="layui-btn layui-btn-primary" onclick="student_clear()">重置</button>
            </div>
        </div>
    </div>
</div>
